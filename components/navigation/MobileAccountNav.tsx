...
export function MobileAccountNav() {
  return (
    <div className="sticky top-[var(--safe-top)] z-30 -mx-1 mb-6 flex min-w-0 items-center justify-between gap-3 border-b border-cocoa/15 bg-canvas/95 px-1 py-2 backdrop-blur-xl lg:hidden">

...
const AvatarOutfitPreviewSchema = new Schema(
  {
    ...
    validationStatus: { type: String, enum: ["not_started", "pending", "passed", "failed", "unavailable"], default: "not_started", index: true },
    validationSafeReason: { type: String, default: "", maxlength: 120 },
    validationCheckedItemIds: { type: [String], default: [] },
    validationMissingItemIds: { type: [String], default: [] },
    validationMismatchedItemIds: { type: [String], default: [] },
    validationAttempts: { type: Number, default: 0, min: 0 },
    validationLastAttemptAt: { type: Date, default: null },

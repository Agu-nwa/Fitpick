...
const UserSchema = new Schema(
  {
    ...
    weatherCountryName: { type: String, default: "", trim: true, maxlength: 80 },
    weatherCityName: { type: String, default: "", trim: true, maxlength: 80 },
...
export function toSafeUser(user: UserDocument): SafeUser {
  return {
    ...
    weatherCountryCode: user.weatherCountryCode || undefined,
    weatherCountryName: user.weatherCountryName || undefined,
    weatherCityName: user.weatherCityName || undefined,

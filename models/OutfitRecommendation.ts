...
const OutfitRecommendationSchema = new Schema(
  {
    ...
    recommendationPieces: { type: Schema.Types.Mixed, default: [] },
    ...
    preview: {
      ...
      validationStatus: { type: String, enum: ["not_started", "pending", "passed", "failed", "unavailable"], default: "not_started" },
      validationSafeReason: { type: String, default: "" },

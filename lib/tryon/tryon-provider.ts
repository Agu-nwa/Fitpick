  ...
  const preview = await AvatarOutfitPreview.findOneAndUpdate(
    { userId: input.userId, outfitId: input.outfitId, cacheKey },
    {
      $set: {
        ...
        providerFailedItemIds: output.providerFailedItemIds || [],
        providerSkippedItemIds: output.providerSkippedItemIds || [],
  ...
  await OutfitRecommendation.findOneAndUpdate(
    { _id: input.outfitId, userId: input.userId },
    {
      $set: {
        ...
        "preview.providerFailedItemIds": output.providerFailedItemIds || [],
        "preview.providerSkippedItemIds": output.providerSkippedItemIds || [],

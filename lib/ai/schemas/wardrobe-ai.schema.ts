...
export const wardrobeAiFieldsSchema = z.object({
  ...
  sizeSystem: aiTextFieldSchema.extend({ value: z.enum(["US", "UK", "EU", "international", "custom", "unknown"]).nullable() }).default({ value: "unknown", confidence: 0, source: "system_inferred" }),
  ...
  eventRelevance: aiTextFieldSchema,

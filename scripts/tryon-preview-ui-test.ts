...
assert.ok(source.includes("Accessories paired with this look"), "Accessories must have a prominent visual panel beside the preview.");
assert.ok(source.includes("Styled alongside your preview"), "The accessory panel must explain that finishers are presented without altering the generated outfit.");

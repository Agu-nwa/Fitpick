    ...
    >
      ...
      <section className="grid w-full min-w-0 gap-5 overflow-hidden pb-6 lg:grid-cols-2">
        <Link href="/stylist/create-look" className="focus-ring group block min-w-0 max-w-full rounded-xl3">
          <Card className="min-h-[22rem] w-full min-w-0 overflow-hidden border-cocoa/20 bg-surface/88 p-6 shadow-card transition duration-300 group-hover:-translate-y-1 group-hover:border-cocoa/40 sm:min-h-[24rem] sm:p-7">

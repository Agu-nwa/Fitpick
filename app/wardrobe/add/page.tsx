  ...
  return (
    <AppShell>
      ...
      <div className="mt-5 rounded-2xl border border-line bg-surfaceWarm p-4 sm:flex sm:items-center sm:justify-between sm:gap-4">
        <div><p className="text-sm font-semibold text-ink">Adding several different items?</p><p className="mt-1 text-xs leading-5 text-muted">Upload up to five photos and let MyFitPick prepare each item separately.</p></div>

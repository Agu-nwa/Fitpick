  ...
  return (
    <AppShell>
      <header className="border-b border-line pb-6 pt-2 sm:pb-8">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight text-ink sm:text-4xl">Try-On History</h1>
        <p className="mt-3 max-w-xl text-sm leading-6 text-muted sm:text-base">Your generated Virtual Try-On previews, newest first.</p>
      </header>
      <TryOnHistoryClient />
    </AppShell>
  );
